...
### How to patch Furniture Data (specifically)
...
With this full CP integration, you can make a Furniture Pack entirely within a CP Content Pack thanks to FF's default Pack: a Furniture Pack internally generated by FF that any CP mod can patch into. See the [Full CP Pack Template](Templates/Full%20CP%20Pack/) if you're interested in doing that. It also has a couple examples of how to edit fields in the data.
