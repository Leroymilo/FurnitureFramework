...
- Taking tools with slots (fishing rods and slingshots) out of a storage furniture or a table slot will delete all items attached to them (should be fixed in SV 1.6.16).
