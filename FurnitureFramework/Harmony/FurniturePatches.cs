...
*/
	...
	internal class BedFurniturePostFixes
	{
		...
		)
		{
			try
			{
				if (Type.FurnitureType.has_held_object(__instance)) return false;
			}
			catch (Exception ex)
			{
